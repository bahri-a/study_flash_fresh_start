...
final topicRepositoryProvider = Provider.family<TopicRepository, String>((ref, subjectId) {
...
final topicsListProvider = FutureProvider.family<List<Topic>, String>((ref, subjectId) async {
